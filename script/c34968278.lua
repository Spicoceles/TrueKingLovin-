...
function cid.TKspellsearchfilter(c)
return
end
...
function cid.spop(e,tp,eg,ep,ev,re,r,rp)
    ...
    if g:GetCount()<2 or not g:IsExists(Card.IsAttribute,1,nil,ATTRIBUTE_WATER) then return end --] Disallows activation if you have 0 fire monsters in hand other than itself (?)
        --Orig. 2 ^^
    local g1=nil 
